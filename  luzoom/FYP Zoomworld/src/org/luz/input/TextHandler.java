...
public class TextHandler extends PBasicInputEventHandler {
	 ...
	 */
	public TextHandler(PCanvas canvas, JTextComponent editor) {
		super();
	...
	public PStyledText createText() {
		...
		if (doc instanceof StyledDocument) {
			if (!doc.getDefaultRootElement().getAttributes().isDefined(StyleConstants.FontFamily)|| !doc.getDefaultRootElement().getAttributes().isDefined(StyleConstants.FontSize)) {
